...
-- AddForeignKey
ALTER TABLE "ProductColorVariants" ADD CONSTRAINT "ProductColorVariants_colorId_fkey" FOREIGN KEY ("colorId") REFERENCES "ProductColor"("id") ON DELETE CASCADE ON UPDATE CASCADE;
